...
const dice_roll = [
    ...
    "64126 31142 35242 35221 46362 52166 15625 56631 61264 32111 61426 21211 26536 22242 16141 35461 43663 46223 15466 61234"
]
const dice_roll_hex = [ // echo 'obase=16;ibase=6; '$dice | bc (shell script)
    ...
    "A98102036C6EE1BE3FA72CF2BA56B160F45D3266FD7C5752CA804649AB2E3E36"
]
const dev_random = [ 
    ...
    "55f41c1a5a828b05c6060f911ba3a9d61e97e618bf1d7fe054c647e764be949e"
]
const xor_dice_n_random = [ // python2.7 ./glacierscript.py (glacier protocol)
    ...
    "fc751e1936ec6abbf9a12363a1f518b6eacad47e426128b29e4601aecf90aaa8"
]
const bip39_mnemonic = [ // https://iancoleman.io/bip39/#english (bip39-mnemonic-converter)
    ...
    "wise pottery main horse shop fuel track caught glove autumn economy horse protect health weekend equip chunk neutral muscle addict undo sign primary aim"
]

describe('mnemonic_generator', function () {
    it('calculated mnemonic words matched', function () {
...
describe('mnemonic_generator', function () {
    it('calculated mnemonic words matched', function () {
        var result = mnemonic_generator(dice_roll[3], dev_random[3])
        assert.equal(result, bip39_mnemonic[3], 'mnemonic words does not match');
    });
});